...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="http://127.0.0.1:8000/adminlte/index3.html" class="nav-link">Pagina Principal</a>
      </li>
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <a href="#" class="dropdown-item">
            <i class="fas fa-envelope mr-2"></i> 0 nuevos mensajes
            <span class="float-right text-muted text-sm">3 mins</span>
          </a>
          <div class="dropdown-divider"></div>
          <a href="#" class="dropdown-item">
            <i class="fas fa-file mr-2"></i> 0 nuevas facturaciones
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="http://127.0.0.1:8000/adminlte/index3.html" class="brand-link">
      <img src="http://127.0.0.1:8000/adminlte/dist/img/AdminLTELogo.png"
           ...
           style="opacity: .8">
      <span class="brand-text font-weight-light">Frutexco</span>
    </a>
 ...
 <li class="nav-item has-treeview">
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2020 <a href="http://adminlte.io">FRUTEXCO</a>.</strong> All rights
    reserved.
  </footer>
